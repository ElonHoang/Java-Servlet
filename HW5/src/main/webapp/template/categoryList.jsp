...
<body>
	...
	<table class="table">
		<a class="btn btn-primary"
			href="<c:url value ='category?action=add'></c:url>"><i
			...
			<tbody>
				<c:forEach var="cate" items="${categories}" varStatus="loop">
					<tr>
						...
						<td><a href="category?action=edit&id=${cate.getId()}">Edit</a></td>
						<td><a href="category?action=delete&id=${cate.getId()}">Delete</a></td>
					</tr>
				</c:forEach>
		</c:if>
		</tbody>
